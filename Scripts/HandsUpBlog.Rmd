...
[^2]: I fitted linear models through time, using F-ratio to determine if the linear slopes were significantly different from 0. P values were then corrected for multiple testing. If the slope was p < 0.05, I considered this statistical evidence of a temporal trend.
